...
/**
 * The {@code CelsiusToFahrenheitConverter} contains the implementation of
 * the CelsiusToFahrenheitConverter class
 *
 * @version 1.0
 */
class CelsiusToFahrenheitConverter implements ITemperatureValueConverter {
