///-----------------------------------------------------------------------///
/// @file ITransport.java                                                 ///
/// @brief Contains the interface of "transport"                          ///
///-----------------------------------------------------------------------///
...
/**
 * The {@code ITransport} interface contains the definition of
 * the "transport" subject (in order to be able to "categorize" the
