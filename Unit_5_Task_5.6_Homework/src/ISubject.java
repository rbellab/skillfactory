///-----------------------------------------------------------------------///
/// @file ISubject.java                                                   ///
/// @brief Contains the interface of "subject"                            ///
///-----------------------------------------------------------------------///
...
/**
 * The {@code ISubject} interface contains the definition of
 * the "subject" (in order to be able to "categorize" the
 * obejcts in the system).
 *
 * @version 1.0
 */
public interface ISubject extends IMovable {
}
